            ...
            return (
                ...
                <div className="testRegistration">
                    <div className="containerRegistration">
                        <h1>Koordináta létrehozása</h1>
                        <form onSubmit={(event) => {
                            event.preventDefault();
                            const form = event.target;

                            axios.post("http://localhost/thrivetribe-server/public/api/locations/create", {
                            ...
                            <div className="custom-inputRegistration">
                                <input type="lat" name="latitude"/>
                            </div>
                            <label>Hosszúsági fok</label>
                            <div className="custom-inputRegistration">
                                <input type="long" name="longitude"/>
                            </div>
